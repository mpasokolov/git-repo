...
$(function () {
  ...
  $city.on('input', function () {
    ...
    //Если данных нет и пользователь ввел больше 3 символов то получаем их
  ...
  $('#myForm').on('submit', function (ev) {
    ...
    if (!validateNameRez || !validatePhoneRez || !validateEmailRez || !validateCityRez) {
      ev.preventDefault();
    }
  });
});
...
function loadData(callback) {
  $.get("http://localhost:63342/task3/city.json", function (response) {
    callback(response);
  })
}
