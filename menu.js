...
function SuperMenu(className, id, href, title, items) {
  Menu.call(this);
  this.href = href;
  this.title = title;
  this.items = items;
...
SuperMenu.prototype.render = function() {
  ...
  var menuPoint = document.createElement('li');
  menuPoint.className = 'menu-point';

  var link = document.createElement('a');
  link.href = this.href;
  link.textContent = this.title;

  menuPoint.appendChild(link);
  ...
  menuPoint.appendChild(superMenu);
...
window.onload = function() {
  ...
  var items = [
    ...
    new SuperMenu('super-menu', 'super-menu', 'https://geekbrains.ru', 'News', superMenuItems),
